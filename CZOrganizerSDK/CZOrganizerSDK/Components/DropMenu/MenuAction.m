...
+ (instancetype)actionWithTitle:(NSString *)title style:(MenuActionStyle)style {
    ...
    action.titleLabel.font =  [UIFont fontWithName:@"PingFang-SC-Medium" size:13];
    action.titleLabel.lineBreakMode = NSLineBreakByTruncatingTail;
    [action setTitleColor:[UIColor colorWithRed:61/255.0 green:67/255.0 blue:83/255.0 alpha:1.0] forState:UIControlStateNormal];
...
+ (UIImage *)drawTriangleWithFront:(BOOL)front {
    ...
    if (front) {
        ...
        [triangleLayer setFillColor:[UIColor colorWithRed:215/255.0 green:215/255.0 blue:230/255.0 alpha:1.0].CGColor];
    }else {
