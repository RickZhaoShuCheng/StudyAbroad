...
@implementation CZPageScrollContentView

- (void)dealloc
{
    for (UIViewController<CZScrollContentControllerDeleagte> *controller in _contentControllers) {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context
{
    ...
    if ([keyPath isEqualToString:@"contentScrollView.contentOffset"]) {
        ...
        UIViewController<CZScrollContentControllerDeleagte> *controller = (__bridge UIViewController<CZScrollContentControllerDeleagte> *)(context);
