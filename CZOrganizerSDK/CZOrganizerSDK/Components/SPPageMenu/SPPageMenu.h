...
- (void)insertItemWithTitle:(nullable NSString *)title atIndex:(NSInteger)itemIndex animated:(BOOL)animated;
- (void)insertItemWithImage:(nullable UIImage *)image  atIndex:(NSInteger)itemIndex animated:(BOOL)animated;
...
- (void)setTitle:(nullable NSString *)title forItemAtIndex:(NSInteger)itemIndex;
// 获取指定item的标题
- (nullable NSString *)titleForItemAtIndex:(NSInteger)itemIndex;

// 设置指定item的图片,设置后，如果原先的item为title，则title会被图片替换
- (void)setImage:(nullable UIImage *)image forItemAtIndex:(NSInteger)itemIndex;
// 获取指定item的图片
- (nullable UIImage *)imageForItemAtIndex:(NSInteger)itemIndex;
 ...
 */
- (void)setTitle:(nullable NSString *)title image:(nullable UIImage *)image imagePosition:(SPItemImagePosition)imagePosition imageRatio:(CGFloat)ratio forItemIndex:(NSInteger)itemIndex;
