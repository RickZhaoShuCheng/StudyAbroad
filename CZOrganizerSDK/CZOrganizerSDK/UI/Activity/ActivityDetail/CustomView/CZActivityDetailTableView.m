...
@interface CZActivityDetailTableView()<UITableViewDelegate ,UITableViewDataSource>

@end
@implementation CZActivityDetailTableView
...
- (CZActivityDetailHeaderView *)headerView{
    if (!_headerView) {
        _headerView = [[CZActivityDetailHeaderView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, ScreenScale(1000))];
    }
    return _headerView;
}
@end
