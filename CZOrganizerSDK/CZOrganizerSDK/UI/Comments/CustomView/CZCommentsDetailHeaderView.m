...
- (void)setImgArr:(NSMutableArray *)imgArr{
    ...
    [imgCount addAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:WidthRatio(24)]} range:NSMakeRange(0, 1)];
    [imgCount addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:WidthRatio(20)]} range:NSMakeRange(1, tempStr.length - 1)];
...
- (void)initWithUI{
    ...
    self.imgCountLab.layer.cornerRadius = HeightRatio(36)/2.0;
    ...
    [self.imgCountLab mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(self.cycleScrollView.mas_bottom).offset(-HeightRatio(20));
        make.width.mas_greaterThanOrEqualTo(WidthRatio(80));
        make.height.mas_equalTo(HeightRatio(36));
    }];
    
    self.avatarView = [[UIImageView alloc]init];
    self.avatarView.layer.masksToBounds = YES;
    self.avatarView.layer.cornerRadius = WidthRatio(70)/2;
    [self addSubview:self.avatarView];
    [self.avatarView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.mas_leading).offset(WidthRatio(30));
        make.top.mas_equalTo(self.cycleScrollView.mas_bottom).offset(HeightRatio(32));
    ...
    self.browseLab.font = [UIFont systemFontOfSize:WidthRatio(22)];
    ...
    [self.nameLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.avatarView.mas_trailing).offset(WidthRatio(20));
        make.top.mas_equalTo(self.avatarView);
        make.trailing.mas_equalTo(self.browseLab.mas_leading).offset(-WidthRatio(20)).priorityLow();
    ...
    [self.contentLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.mas_leading).offset(WidthRatio(30));
        make.height.mas_greaterThanOrEqualTo(0);
        make.top.mas_equalTo(self.avatarView.mas_bottom).offset(HeightRatio(25));
        make.trailing.mas_equalTo(self.mas_trailing).offset(-WidthRatio(30));
    }];
    ...
    [self.rankView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.leading.mas_equalTo(self.mas_leading).offset(WidthRatio(30));
        make.top.mas_equalTo(self.contentLab.mas_bottom).offset(HeightRatio(30));
    ...
    [goodsView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.mas_leading).offset(WidthRatio(30));
        make.trailing.mas_equalTo(self.mas_trailing).offset(-WidthRatio(30));
        make.top.mas_equalTo(self.evaluateLab.mas_bottom).offset(HeightRatio(50));
        make.height.mas_equalTo(HeightRatio(186));
    }];
    ...
    [self.goodsImg mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(goodsView.mas_leading).offset(WidthRatio(18));
        make.top.mas_equalTo(goodsView.mas_top).offset(HeightRatio(18));
        make.bottom.mas_equalTo(goodsView.mas_bottom).offset(-HeightRatio(18));
        make.width.mas_equalTo(self.goodsImg.mas_height);
    }];
    
    self.goodsName = [[UILabel alloc]init];
    self.goodsName.font = [UIFont systemFontOfSize:WidthRatio(26)];
    ...
    paragraphStyle.lineSpacing = WidthRatio(15); // 调整行间距
    ...
    [self.goodsName mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.goodsImg.mas_trailing).offset(WidthRatio(20));
        make.top.mas_equalTo(self.goodsImg.mas_top);
        make.height.mas_greaterThanOrEqualTo(0);
        make.trailing.mas_equalTo (goodsView.mas_trailing).offset(-WidthRatio(30));
    }];
    
    self.organizerName = [[UILabel alloc]init];
    self.organizerName.font = [UIFont systemFontOfSize:WidthRatio(24)];
    ...
    [self.organizerName mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.goodsImg.mas_trailing).offset(WidthRatio(20));
        make.top.mas_equalTo(self.goodsName.mas_bottom).offset(HeightRatio(15));
        make.height.mas_greaterThanOrEqualTo(0);
        make.trailing.mas_equalTo (goodsView.mas_trailing).offset(-WidthRatio(30));
    }];
    ...
    [tempStr addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:WidthRatio(24)]} range:NSMakeRange(0, 1)];
    [tempStr addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:WidthRatio(30)]} range:NSMakeRange(1, str.length -1)];
    ...
    self.oldPriceLab.font = [UIFont systemFontOfSize:WidthRatio(22)];
    ...
    [self.oldPriceLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.priceLab.mas_trailing).offset(WidthRatio(16));
    ...
    allCommentsLab.font = [UIFont boldSystemFontOfSize:WidthRatio(32)];
    ...
    [allCommentsLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.mas_leading).offset(WidthRatio(30));
        make.top.mas_equalTo(goodsView.mas_bottom).offset(HeightRatio(48));
        make.width.height.mas_greaterThanOrEqualTo(0);
    }];
    ...
    [self.countLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(allCommentsLab.mas_trailing).offset(WidthRatio(16));
...
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView didScrollToIndex:(NSInteger)index{
    ...
    [imgCount addAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:WidthRatio(24)]} range:NSMakeRange(0, indexStr.length)];
    [imgCount addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:WidthRatio(20)]} range:NSMakeRange(indexStr.length, tempStr.length + 1)];
    self.imgCountLab.attributedText = imgCount;
}
@end
