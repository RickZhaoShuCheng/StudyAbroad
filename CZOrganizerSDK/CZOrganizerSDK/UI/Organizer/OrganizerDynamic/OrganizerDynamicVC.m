...
@interface OrganizerDynamicVC ()
@property (nonatomic ,strong)UILabel *titleLab;//标题
@property (nonatomic ,strong)UIButton *backBtn;//返回按钮
@property (nonatomic ,strong)UIButton *shareBtn;//分享按钮
@property (nonatomic ,strong) OrganizerDynamicTableView *tableView;
@property (nonatomic ,assign) CGFloat alpha;
@end

@implementation OrganizerDynamicVC
...
- (OrganizerDynamicTableView *)tableView{
    if (!_tableView) {
        _tableView = [[OrganizerDynamicTableView alloc]initWithFrame:CGRectZero style:UITableViewStylePlain];
    }
    return _tableView;
}
