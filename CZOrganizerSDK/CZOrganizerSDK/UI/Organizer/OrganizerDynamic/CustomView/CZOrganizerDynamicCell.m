...
@interface CZOrganizerDynamicCell()<UIScrollViewDelegate>

@end
@implementation CZOrganizerDynamicCell
...
- (void)initWithUI{
    ...
    self.postVC = [[CZOrganizerDynamicPostVC alloc]init];
