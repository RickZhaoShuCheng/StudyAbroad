...
#import "CZOrganizerDynamicTableView.h"
#import "CZOrganizerDynamicSectionHeaderView.h"


@interface CZOrganizerDynamicTableView()<UITableViewDelegate,UITableViewDataSource,SPPageMenuDelegate>

@end
@implementation CZOrganizerDynamicTableView
...
//        self.bounces = NO;
        ...
        [self registerClass:[CZOrganizerDynamicCell class] forCellReuseIdentifier:NSStringFromClass([CZOrganizerDynamicCell class])];
        [self registerClass:[CZOrganizerDynamicSectionHeaderView class] forHeaderFooterViewReuseIdentifier:NSStringFromClass([CZOrganizerDynamicSectionHeaderView class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    self.cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([CZOrganizerDynamicCell class]) forIndexPath:indexPath];
    WEAKSELF
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    CZOrganizerDynamicSectionHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass([CZOrganizerDynamicSectionHeaderView class]) ];
...
- (CZOrganizerDynamicTableHeaderView *)headerView{
    if (!_headerView) {
        _headerView = [[CZOrganizerDynamicTableHeaderView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenWidth-NaviH)];
        WEAKSELF
