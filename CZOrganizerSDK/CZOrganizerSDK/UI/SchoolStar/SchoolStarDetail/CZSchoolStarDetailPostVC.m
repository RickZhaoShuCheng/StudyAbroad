...
@interface CZSchoolStarDetailPostVC ()
@property (nonatomic ,assign) NSInteger pageNum;
@end

@implementation CZSchoolStarDetailPostVC
...
- (CZSchoolStarDetailPostTableView *)tableView{
    if (!_tableView) {
        _tableView = [[CZSchoolStarDetailPostTableView alloc]initWithFrame:CGRectZero style:UITableViewStylePlain];
    }
    return _tableView;
}
