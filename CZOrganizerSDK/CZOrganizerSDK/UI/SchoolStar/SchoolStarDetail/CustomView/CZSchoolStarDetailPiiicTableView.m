...
#import "CZSchoolStarDetailPiiicTableView.h"

@interface CZSchoolStarDetailPiiicTableView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation CZSchoolStarDetailPiiicTableView
