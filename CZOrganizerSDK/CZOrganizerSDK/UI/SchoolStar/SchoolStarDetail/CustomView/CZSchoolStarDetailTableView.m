...
@interface CZSchoolStarDetailTableView ()<UITableViewDelegate,UITableViewDataSource,SPPageMenuDelegate>

@end
@implementation CZSchoolStarDetailTableView
...
//        self.bounces = NO;
        ...
        [self registerClass:[CZSchoolStarDetailCell class] forCellReuseIdentifier:NSStringFromClass([CZSchoolStarDetailCell class])];
        [self registerClass:[CZSchoolStarDetailSectionHeaderView class] forHeaderFooterViewReuseIdentifier:NSStringFromClass([CZSchoolStarDetailSectionHeaderView class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    self.cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([CZSchoolStarDetailCell class]) forIndexPath:indexPath];
    WEAKSELF
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    CZSchoolStarDetailSectionHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass([CZSchoolStarDetailSectionHeaderView class]) ];
...
- (CZSchoolStarDetailTableHeaderView *)headerView{
    if (!_headerView) {
        _headerView = [[CZSchoolStarDetailTableHeaderView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, ScreenScale(780))];
        WEAKSELF
