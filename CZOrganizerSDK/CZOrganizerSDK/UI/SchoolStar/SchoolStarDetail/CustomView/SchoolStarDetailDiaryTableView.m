...
#import "SchoolStarDetailDiaryTableView.h"

@interface SchoolStarDetailDiaryTableView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation SchoolStarDetailDiaryTableView
