...
@interface CZSchoolStarDetailCell ()<UIScrollViewDelegate>

@end
@implementation CZSchoolStarDetailCell
...
-(void)setUserId:(NSString *)userId{
    ...
    if (userId) {
        WEAKSELF
        if (!self.postVC) {
            self.postVC = [[CZSchoolStarDetailPostVC alloc]init];
        ...
        if (!self.piiicVC) {
            self.piiicVC = [[CZSchoolStarDetailPiiicVC alloc]init];
        ...
        if (!self.diaryVC) {
            self.diaryVC = [[CZSchoolStarDetailDiaryVC alloc]init];
