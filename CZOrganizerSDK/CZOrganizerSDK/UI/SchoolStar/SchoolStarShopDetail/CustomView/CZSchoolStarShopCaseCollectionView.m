...
@interface CZSchoolStarShopCaseCollectionView()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>

@end
@implementation CZSchoolStarShopCaseCollectionView
