...
@interface SchoolStarShopDetailTableView()<UITableViewDelegate,UITableViewDataSource,SPPageMenuDelegate>

@end
@implementation SchoolStarShopDetailTableView
...
//        self.bounces = NO;
        ...
        [self registerClass:[SchoolStarShopDetailCell class] forCellReuseIdentifier:NSStringFromClass([SchoolStarShopDetailCell class])];
        [self registerClass:[SchoolStarShopDetailSectionHeaderView class] forHeaderFooterViewReuseIdentifier:NSStringFromClass([SchoolStarShopDetailSectionHeaderView class])];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    SchoolStarShopDetailSectionHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:NSStringFromClass([SchoolStarShopDetailSectionHeaderView class]) ];
...
- (SchoolStarShopDetailTableHeaderView *)headerView{
    if (!_headerView) {
        _headerView = [[SchoolStarShopDetailTableHeaderView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, ScreenScale(540))];
    }
    return _headerView;
}
@end
